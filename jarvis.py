...
def Creator():
    speak(
        "I have a passion for Robotics, Artificial Intelligence and Machine Learning ,"
        "I am very co-operative ,"
        "If you are facing any problem regarding 'Jarvis', I will be glad to help you ")
    ...
    while True:
        ...
        # elif 'search' in query:
            ...
            try:
                ...
                jsonObj = urlopen(
                    '''https://newsapi.org/v2/top-headlines?country=in&apiKey=d2725764df8a45e08de8f7cab6748635''')
        ...
        # General Questions
            ...
            client = wolframalpha.Client("WHJKU8-Q5E2RQYTPH")
